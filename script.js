document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(field) {
    ...
    const label = (function () {
      ...
      return lbl ? lbl.textContent.trim() : name;
    }());

    if (field.validity.valueMissing) {
      return label + ' is required.';
    }
    if (field.validity.typeMismatch && type === 'email') {
    ...
    if (field.validity.patternMismatch) {
      return field.dataset.patternError || label + ' format is invalid.';
    }
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fetch(action, {
      ...
      .then(function () {
        ...
        successMsg.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent.';
      ...
      .catch(function () {
        ...
        errorMsg.textContent = form.dataset.errorMessage || 'Something went wrong. Please try again later.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SecondClick משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'd00cab7a-1f00-48c4-90d4-b669f2278964',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'd00cab7a-1f00-48c4-90d4-b669f2278964';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd00cab7a-1f00-48c4-90d4-b669f2278964';
